...
var useAuth = () => {
  ...
  const signIn = (0, import_react2.useCallback)((credentials) => {
    if (typeof credentials === "string") {
      return client.signInWithEmail(credentials);
    }
    return client.signIn(credentials);
  }, [client]);
  const signUp = (0, import_react2.useCallback)((data) => client.signUp(data), [client]);
...
var SignIn = () => {
  ...
  if (isMFAChallenge) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "authify-card", style: { textAlign: "center" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: "48px", marginBottom: "16px" }, children: "\u{1F510}" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "authify-title", children: "Two-Factor Authentication" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: { color: "#666", marginBottom: "24px", lineHeight: "1.5" }, children: "Enter the 6-digit code from your authenticator app" }),
      error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "authify-error", children: error }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("form", { onSubmit: handleMFASubmit, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "authify-input-group", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            type: "text",
            value: mfaCode,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "authify-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "authify-title", children: mode === "signin" ? "Sign In" : "Sign Up" }),
    error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "authify-error", children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("form", { onSubmit: handleSubmit, children: [
      mode === "signup" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "authify-input-group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "authify-label", children: "Name" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "authify-input-group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "authify-label", children: "Password (optional)" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            type: "password",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { marginTop: "16px", textAlign: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
